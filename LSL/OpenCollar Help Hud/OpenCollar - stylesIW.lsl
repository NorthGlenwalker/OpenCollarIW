...
{
    Dialog(kAv, "\n<pre>styles - this menu
Sample styles notecard in hud.
each line is formated as [partname]~[texture UUID or included texture name]~[color code]~[shiny level] eg Leather~ ~<1,0.14902,0.5098>~ or Metal~Celtic~ ~1 or Gem~Diamond~<0.5,0,0.5>~2
blank parts are default settings
