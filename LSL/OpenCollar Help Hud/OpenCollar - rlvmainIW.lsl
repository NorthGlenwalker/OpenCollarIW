...
<pre>rlvon - turns on RLV
<pre>rlvoff - turns off RLV
<pre>showrestrictions - shows which objects is restricting you
<pre>clear - clear all restrictions
<pre>sitmenu - Sit menu
<pre>rlvtp - Travel menu
<pre>rlvtalk - Talk menu
<pre>rlvtouch - Touch menu
<pre>rlvmisc - Misc menu
<pre>rlvview - v̶i̶e̶w̶ Menu
