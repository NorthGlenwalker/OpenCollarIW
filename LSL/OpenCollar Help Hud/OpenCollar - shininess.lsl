...
{
    string sPrompt = "\n<pre>shiny - this menu
<pre>setshiny [prim name as in it's description] [shiny level 0=off 3=high] eg <pre>setshiny Metal 2
Pick which part of the "+CTYPE+" you would like to change shiny.\n\nChoose *Touch* if you want to select the part by directly clicking on the "+CTYPE+".";
